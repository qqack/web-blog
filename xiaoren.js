...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br />    <a href=\"http://ihuan.me\" title=\"首页\">首页</a>    <a href=\"http://ihuan.me/liu\" title=\"留言\">留言</a>    <a href=\"http://ihuan.me/wp-login.php\" title=\"后台\">后台</a> ",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '阅读我的文章 ' + title + ' ', 6000);
    }
    $(".spig").animate({
